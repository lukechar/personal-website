...
const Projects = (props) => {
    return(
        <div className="container">
            ...
            <div className="row">
                <div className="col s12 m6">
                    <GithubCard image="../img/snowfall_screenshot.png" title="Snowfall Phone App" content="Phone app that consumes the snowfall_api to provide snowfall reports and forecasts for ski areas. Built with Flutter." githubLink="https://github.com/lukechar/snowfall/"></GithubCard>
                </div>
            </div>
        </div>
    );
